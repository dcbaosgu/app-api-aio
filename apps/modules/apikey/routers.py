...
@router.post("/generate", status_code=201, responses={
                201: {"model": schemas.APIKeyResponse, "description": "Create items success"}})
...
@router.get("/search", status_code=200, responses={
                200: {"model": schemas.PaginatedAPIKeyResponse, "description": "Get items success"}})
